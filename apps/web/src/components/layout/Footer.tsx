      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Logo variant="mono" />
            <p className="mt-4 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.50)" }}>
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="hover:text-amber-400 transition-colors" style={{ color: "rgba(255,255,255,0.35)" }}
              >
              ...
              {SERVICES.filter((service) => service.indexable !== false).map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="text-sm hover:text-white transition-colors" style={{ color: "rgba(255,255,255,0.50)" }}
                  >
                    {service.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <a
                ...
                className="text-sm hover:text-white transition-colors block" style={{ color: "rgba(255,255,255,0.50)" }}
              >
                hello@speedyvan.uk
              </a>
            </div>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
          ...
          <div className="flex gap-6">
            ...
            <Link href="/cookies" className="text-xs hover:text-white transition-colors" style={{ color: "rgba(255,255,255,0.35)" }}>
              Cookies
            </Link>
          </div>
        </div>
